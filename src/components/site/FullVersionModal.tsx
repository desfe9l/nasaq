            ...
            <div className="space-y-4">
              <div className="rounded-[10px] border border-line/70 p-4 dark:border-white/10 dark:bg-white/[0.02]">
                ...
                <div className="relative">
                  <input id="nasaq-license-key" type="text" dir="ltr" autoComplete="off" spellCheck={false} value={licenseKey} onChange={(e) => { setLicenseKey(e.target.value); setErrorMessage(null); }} onKeyDown={(e) => { if (e.key === "Enter") void handleActivate(); }} placeholder="NASAQ-XXXX-XXXX-XXXX" className="h-11 w-full rounded-[10px] border border-line bg-white pe-4 ps-10 font-mono text-[13px] font-semibold tracking-wider text-[#0F1E33] placeholder:text-[#98a2b3] focus:border-[#0F1E33] focus:outline-none dark:border-white/10 dark:bg-[#111722] dark:text-white" />
