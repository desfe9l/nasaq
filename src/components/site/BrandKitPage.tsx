  ...
  return (
    <div className="min-h-full bg-paper dark:bg-[#111722]">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <section className="py-12"><h2 className="text-[20px] font-extrabold">معلومات المنتج</h2><dl className="mt-5 grid gap-3 sm:grid-cols-3"><Fact label="اسم المنتج" value="نَسَق | NASAQ" /><Fact label="المصمم والمطور" value={BRAND.owner} /><Fact label="نوع المنتج" value="منصة تصميم وتحرير عربية" /></dl></section>
