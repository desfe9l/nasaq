 ...
 *
 *   Phase 1 (`?providerId=…`): start OAuth server-side and 302 straight to
 *     Google. The popup never paints the app.
 *   Phase 2 (`?done=1`): after the Google round-trip, emit a tiny HTML page that
