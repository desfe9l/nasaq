...
export const PROGRESS_PRESETS: ProgressPreset[] = [
  ...
  },
  {
    ...
    w: 110,
    h: 22,
    style: { value: 75, showValue: true, fontSize: 14, variant: "bar" },
  },
  {
    id: "ring",
    label: "دائرة كنسبة",
    ...
    w: 44,
    h: 44,
    style: { value: 68, showValue: true, fontSize: 11, variant: "ring" },
  },
  {
    id: "ring-steps",
    label: "حلقة مراحل",
    ...
    w: 54,
    h: 54,
    style: { value: 50, showValue: true, fontSize: 9, variant: "ring" },
  },
  {
    id: "steps",
    label: "خطوات",
    ...
    w: 140,
    h: 18,
    style: { value: 60, showValue: true, fontSize: 10, variant: "bar" },
  },
  {
    id: "dots",
    label: "نقاط",
    ...
    w: 100,
    h: 16,
    style: { value: 80, showValue: false, variant: "bar", radius: 999 },
  },
  {
    id: "stages",
    label: "مراحل",
    ...
    w: 120,
    h: 20,
    style: { value: 40, showValue: true, fontSize: 11, variant: "bar", radius: 0 },
  },
  {
    id: "milestone",
    label: "معلم",
    ...
    w: 120,
    h: 20,
    style: { value: 100, showValue: true, fontSize: 11, variant: "bar" },
  },
  {
    id: "circular-stage",
    label: "دائري مراحل",
    ...
    w: 48,
    h: 48,
    style: { value: 60, showValue: true, fontSize: 9, variant: "ring" },
  },
  {
    id: "not-started",
    label: "لم يبدأ",
    ...
    w: 110,
    h: 18,
    style: { value: 0, showValue: true, fontSize: 10, variant: "bar" },
  },
  {
    id: "in-progress",
    label: "قيد التنفيذ",
    ...
    w: 110,
    h: 18,
    style: { value: 50, showValue: true, fontSize: 10, variant: "bar" },
  },
  {
    id: "completed",
    label: "مكتمل",
    ...
    w: 110,
    h: 18,
    style: { value: 100, showValue: true, fontSize: 10, variant: "bar" },
  },
];
